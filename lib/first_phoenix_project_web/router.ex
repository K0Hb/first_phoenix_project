defmodule FirstPhoenixProjectWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {FirstPhoenixProjectWeb.Layouts, :root}
  ...
  if Application.compile_env(:first_phoenix_project, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FirstPhoenixProjectWeb.Telemetry
